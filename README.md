...
| `tcpraw servers` | Test każdego serwera osobno: ping, wolne miejsce, 2 s download i 2 s upload; tabela z wynikami. |
...
| `tcpraw servers` | Test each server separately: ping, free space, 2s download and 2s upload; results table. |
